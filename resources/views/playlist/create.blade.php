                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-8 border-right">
                                ...
                                {{-- Album dropdown --}}
                                <div class="form-group">
                                    <label class="mb-1">Album</label>
                                    <select name="albam" class="form-control">
                                        <option value="">-- Select Album --</option>
                                        @foreach ($albams as $albam)
                                            <option value="{{ $albam->id }}"
                                                {{ (string)$albam->id === (string)$selectedAlbamId ? 'selected' : '' }}>
                                                {{ $albam->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="content_type" id="contentTypeSelect" class="form-control"
                                        ...
                                        <option value="audio" {{ $selectedContentType === 'audio' ? 'selected' : '' }}>Music Track</option>
                                        <option value="video" {{ $selectedContentType === 'video' ? 'selected' : '' }}>Video Track</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                ...
                                <div class="form-group" id="audioSection"
                                     style="{{ $selectedContentType === 'video' ? 'display:none;' : '' }}">
